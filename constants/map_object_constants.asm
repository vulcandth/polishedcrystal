...
; SpriteMovementData indexes (see data/sprites/map_objects.asm)
	...
	const SPRITEMOVEDATA_FOLLOWEROBJ          ; 39
	const SPRITEMOVEDATA_POKEBALL_OPENING     ; 3a
	const SPRITEMOVEDATA_POKEBALL_CLOSING     ; 3b
...
; StepFunction_FromMovement.Pointers indexes (see engine/overworld/map_objects.asm)
	...
	const SPRITEMOVEFN_FOLLOWER_OBJ          ; 20
	const SPRITEMOVEFN_POKEBALL_OPENING      ; 21
	const SPRITEMOVEFN_POKEBALL_CLOSING      ; 22
...
; _HandleStepType.StepTypesJumptable indexes (see engine/overworld/map_objects.asm)
	...
	const STEP_TYPE_POKEBALL_OPENING ; 1b
	const STEP_TYPE_POKEBALL_CLOSING ; 1c
	const STEP_TYPE_NPC_JUMP_INPLACE ; 1d
