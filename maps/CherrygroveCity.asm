CherrygroveCity_MapScriptHeader:
	...
	bg_event 32,  4, BGEVENT_OAM_ANIMATE, CHERRY_BLOSSOMS_ANIM
	bg_event 33,  4, BGEVENT_OAM_ANIMATE, CHERRY_BLOSSOMS_ANIM
	bg_event 32,  5, BGEVENT_OAM_ANIMATE, CHERRY_BLOSSOMS_ANIM
	bg_event 33,  5, BGEVENT_OAM_ANIMATE, CHERRY_BLOSSOMS_ANIM
	bg_event 34,  8, BGEVENT_OAM_ANIMATE, CHERRY_BLOSSOMS_ANIM
	bg_event 35,  8, BGEVENT_OAM_ANIMATE, CHERRY_BLOSSOMS_ANIM
	bg_event 34,  9, BGEVENT_OAM_ANIMATE, CHERRY_BLOSSOMS_ANIM
	bg_event 35,  9, BGEVENT_OAM_ANIMATE, CHERRY_BLOSSOMS_ANIM
	bg_event 36,  2, BGEVENT_OAM_ANIMATE, CHERRY_BLOSSOMS_ANIM
	bg_event 37,  2, BGEVENT_OAM_ANIMATE, CHERRY_BLOSSOMS_ANIM
	bg_event 36,  3, BGEVENT_OAM_ANIMATE, CHERRY_BLOSSOMS_ANIM
	bg_event 37,  3, BGEVENT_OAM_ANIMATE, CHERRY_BLOSSOMS_ANIM
